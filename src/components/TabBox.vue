<template>
    <TabGroup as="div" class="pt-8 pb-6">
        <TabList class="mx-auto flex w-fit gap-3 rounded-3xl bg-[#E1E1E1] py-3 px-4">
        ...
        <TabPanels class="mx-auto mt-8 w-[80%]">
            <TabPanel class="grid grid-cols-3 gap-4">
                <div class="aspect-1 rounded-3xl bg-white shadow-sm">01</div>
                <div class="aspect-1 rounded-3xl bg-white shadow-sm">02</div>
                <div class="aspect-1 rounded-3xl bg-white shadow-sm">03</div>
                <div class="aspect-1 rounded-3xl bg-white shadow-sm">04</div>
                <div class="aspect-1 rounded-3xl bg-white shadow-sm">05</div>
                <div class="aspect-1 rounded-3xl bg-white shadow-sm">06</div>
            </TabPanel>
