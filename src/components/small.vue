<template>
    <TabGroup as="div" class="pt-8 pb-6">
        <TabList class="mx-auto flex w-fit gap-3 rounded-[40px] bg-[#E1E1E1] py-3 px-4">
            <Tab v-slot="{ selected }" as="template">
                <button
                    class="rounded-xl bg-[#F3F3F3] p-3 shadow-md"
        ...
        <TabPanels class="mx-auto mt-8 w-[80%]">
            <TabPanel class="grid grid-cols-2 gap-4 md:grid-cols-4">
                <div
                    class="col-span-2 grid aspect-1 place-content-center rounded-[40px] bg-white shadow-sm"
                >
                    01 Intro
                </div>
                <div
                    class="col-span-2 grid aspect-2 place-content-center rounded-[40px] bg-white shadow-sm md:col-span-1"
                >
                    02 Mapbox
                </div>
                <div class="grid aspect-1 place-content-center rounded-[40px] bg-white shadow-sm">
                    03 Twitter
                </div>
                <div
                    class="aspect-h-2 row-span-2 grid place-content-center rounded-[40px] bg-white shadow-sm"
                >
                    04 Project
                </div>
                <div class="grid aspect-1 place-content-center rounded-[40px] bg-white shadow-sm">
                ...
                <div
                    class="col-span-2 grid aspect-2 place-content-center rounded-[40px] bg-white shadow-sm"
                >
                    10
                </div>
                <div
